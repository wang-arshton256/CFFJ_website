                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 entries pl-3">
                        ...
                        <article class="entry">
                            ...
                            <h2 class="entry-title">Ms. Mbabazi Cynthia</h2>

                            <h6 class="entry-title">Head of Research Data Strategy</h6>


                            <div class="entry-content dexal">
                                <p>

                                    Ms. Cynthia Mbabazi holds a master’s degree in public policy
                                    from KDI School of Public Policy and Management, an MBA and a
                                    bachelor’s degree in Statistics from Makerere University. She is
                                    motivated by new challenges and endeavors to constantly learn
                                    new things. She currently works as a policy researcher with the
                                    Centre for Faith Family and Justice (CFFJ). Before joining CFFJ,
                                    Ms. Cynthia Mbabazi worked as a research consultant for the
                                    Global Delivery Initiative, project coordinator with the African
                                    Youth Action Foundation in SouthKorea, a research and reporting
                                    analyst with MTN Uganda, and an intern with the Ministry of
                                    Foreign Affairs. She is an innovative professional with about
                                    five years’ experience in project planning, research analysis
                                    and performance reporting. She believes that quality research is
                                    the background of effective policy making.
