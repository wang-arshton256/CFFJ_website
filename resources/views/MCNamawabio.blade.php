        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries pl-3">
            ...
            <article class="entry">
              ...
              <h2 class="entry-title">Mr. Namawa Clement Michael</h2>
              
                 <h6 class="entry-title">Director Communications</h6>
              ...
              <div class="entry-content dexal">
                ...
                <a href="{{url ('about')}}" class="btn btn-danger btn-lg btndirect danX">Close</a>
