    ...
    <main id="main">
        ...
        <div class="w3l-homeblock2 w3l-homeblock5 py-5">
            <div class="container pt-md-4 pb-md-5">
                <!-- block -->
                <h3 class="category-title mb-3"> AGONY</h3>
                    ...
                    <div class="col-lg-10">
                        <div class="bg-clr-white hover-box">
                            <div class="row">
                                <div class="col-sm-5 position-relative">
                                    <a href="#blog-single.html" class="image-mobile">
                                        <img class="card-img-bottom d-block radius-image-full pl-4 pt-5"
                                            src="assets/images/agony2.jpg" alt="Card image cap">
                                    </a>
                                </div>
                                <div class="col-sm-7  blog-details align-self">
                                    <a href="#blog-single.html" class="blog-desc pt-5">Domestic
                                        Violence
                                    </a>
                                    <p class=" pr-3 align-self">My name is Sarah. I
                                        am
                                        42years and I live in Bushenyi district, Western Uganda.
                                        When I
                                        was a young girl, I lived with my mother, father and two
                                        sisters. I grew up well in a happy family. I had wishes and
                                        dreams of a happy marriage. But before I got married, my
                                        parents
                                        passed away in a motor accident, leaving me sorrowful.
                                        Nonetheless, I was hopeful that I would find my happiness
                                        with a
                                        husband. My aunt, who lived nearby us in Bushenyi, took over
                                        the
                                        responsibility of taking care of me and my two sisters. My
                                        aunt
                                        prepared me for marriage and ensured that both my
                                        traditional
                                        marriage and church wedding happened successfully. I am
                                        forever
                                ...
                                <div class=" pl-4 card-body blog-details align-self">
                                    <p>My husband was the owner of a
                                        supermarket in Fort Portal. After our wedding, we settled in
                                        Fort Portal to make a home. Over the course of our marriage,
                                        we
                                        had four healthy children, all delivered by c-section.
                                        Throughout these years of conceiving and delivering
                                        children, I
                                        suffered physical and emotional abuse from my husband. He
                                        despised me because he knew I had nobody to run to. He
                                        neglected
                                        me and was constantly jealous and controlling of my dress
                                        code
                                        and movements. He usually came back home after 3 am drunk,
                                        violent and expectant of a warm meal. He slept around with
                                        so
                                        many other women because of his lifestyle but I remained
                                        patient
                                        through it all. I carried on with housework, childcare and
                                        farming responsibilities but slowly grew timid and
                                        despondent.

                                    </p>

                                    <p class="pt-3">Discussions on the issue of physical
                                        and
                                        domestic violence with
                                        family and friends over the years proved to be futile. I
                                        wish my
                                        husband could change, but I have come to accept him for who
                                        he
                                        is, however unpleasant his behavior and actions are. Thanks
                                        to
                                        my faith in God, supportive friends and advisers, I have
                                        managed
                                        to keep a smile on my face while caring for my school-going
                                        children and going about my other responsibilities. To date,
                                        I
                                        keep home and hope that my children will finish school and
                                        grow
                                        up to live a much better life one day.
                                    ...
                                    <div class="col-sm-5 position-relative">
                                        <a href="#blog-single.html" class="image-mobile">
                                            <img class="card-img-bottom d-block radius-image-full"
                                                src="assets/images/beauty8.jpg"
                                                alt="Card image cap">
                                        </a>
                                    </div>
                                    <div class="col-sm-7 card-body blog-details align-self">
                                        <a href="#blog-single.html" class="blog-desc">Winter:
                                            4
                                            Ways to
