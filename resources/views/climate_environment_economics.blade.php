                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/the shea butter.png"
                                            class="img-fluid" alt="">

                                    </div>
                                    <div class="member-info text-center pt-3">

                                        <h4>Author: John Bosco Lamoris Okullo(PhD)<br>Cadreen
                                            Barungi
                                            Kabahizi<br>Florence Bangi<br>Frank Juuko</h4>
                                        <a
                                            href="assets/files/pdfpublications/SheaCommemorationReport.pdf">click
                                            here to read/download</a>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <a
                                            href="assets/files/pdfpublications/ExploringGreenGrowthforUganda'sDevelopment.pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
