                    ...
                    <div class="col-lg-8 entries pl-3">
                        ...
                        <article class="entry">
                            ...
                            <div class="entry-content dexal">
                                <p>
                                    Please complete the following form so that we can email you the
                                ...
                                <a href="standingord.html"
                                    class="btn btn-success btn-lg btndirect">Standing Order</a>
                        ...
                        <article class="entry" pt-2>
                            ...
                            <div class="entry-content dexal">
                                ...
                                <h4 class="">Payment Instructions: Direct Debit</h4>

                                <p class=" pt-3">Our office will send you instructions and
                                    a form to fill out within the next 48 working hours to set up a
                                    Direct Debit with us.</p>
                                </p>




                                <form class="padding-bottom-5">
                                    <div class="form-row ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="inputAddress"
                                            placeholder="Plot 78 Upper Kololo" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputContact">Contact</label>
                                        <input type="tel" class="form-control" id="inputContact"
                                            placeholder="+256 771 000 000">
                                    </div>
                                    ...
                                    <a href="donate.html"
                                        class="btn btn-primary btn-sm btndirect">Previous page</a>
                                    <button type="submit"
