                ...
                <div class="row ">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/nationalidentity.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <a
                                            href="assets/files/pdfpublications/National Identity Paper.pdf">click
                            ...
                            <hr class="d-none" WIDTH="25%" SIZE="20"
                                style="background-color:#99CD44">

                            <div class="section-title pt-5 d-none">
