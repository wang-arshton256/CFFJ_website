                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/howAIcouldtransform.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4>Author: Mrs. Cadreen Barungi Kabahizi</h4>
                                        <a
                                            href="assets/files/pdfpublications/Paper-AI-for-Ug-CFFJ.pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-item categories">
                                ...
                                <ul id="pulicationslist">
                                    ...
                                    <li><a href="{{ url('innovation') }}">Innovation
                                            <span>(1)</span></a></li>
                                    <li><a href="{{ url('innovation') }}">Education
                                            <span>(1)</span></a></li>
