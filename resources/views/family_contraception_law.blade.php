        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="{{ url('ourpartners') }}">Our Partners</a>
                    </li>
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/fwp.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4>Authors:</h4>
                                        <h6>Martin Lwanga(PhD)
                                        <br>Alex Thomas Ijjo(PhD)
                                        <br>Cadreen Barungi Kabahizi
                                        <br>Cynthia Mbabazi</h6>
                                       
                                        <a
                                            href="assets/files/pdfpublications/Barriers Paper 1.pdf">click
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/marriage_and_divorce.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4>Authors: </h4>
                                        <h6>L. Adams, A. T. Ijjo, <br>C. Kabahizi, C. Mbabazi, <br>E. Kabahizi, and M. Juuko
                                        </h6>
                                       
                                        <a
                                            href="assets/files/pdfpublications/Marriage & Divorce paper (1).pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/Analysis of efficiency of legal.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <a
                                            href="assets/files/pdfpublications/AnalysisoftheefficacyoftheLegalFramework.pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/strenghtening uganda's social protection system.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <a
                                            href="assets/files/pdfpublications/SocialProtectionPaper.pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/evaluation of youth.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <a
                                            href="assets/files/pdfpublications/EvaluationoftheUgandaNationalYouthPolicy.pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/fertility trends.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4>Author: Mrs. Cadreen Barungi Kabahizi</h4>
                                        <a
                                            href="assets/files/pdfpublications/FertilityTrendsandEconomicImplications.pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/investigating the effects.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4>Author: Mrs. Cadreen Barungi Kabahizi</h4>
                                        <a
                                            href="assets/files/pdfpublications/InvestigatingtheeffectsofGenderInclusiononFamiliesinUgandapdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/gender perspective.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4>Author: Ms. Cynthia MBabazi</h4>
                                        <a
                                            href="assets/files/pdfpublications/GenderPerspectiveinTradePolicy.pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/The plight of illiterate youth in uganda.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4>Author: Mrs. Cadreen Barungi Kabahizi</h4>
                                        <a
                                            href="assets/files/pdfpublications/ThePlightofIlliterateYouthinUganda.pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sidebar-item categories">
                                ...
                                <ul id="pulicationslist">
                                    ...
                                    <li><a href="{{ url('climate_environment_economics') }}">Climate,
                                            ...
                                            <li><a href="{{ url('economy_family_development') }}">Development
                                            <span>(1)</span></a></li>
