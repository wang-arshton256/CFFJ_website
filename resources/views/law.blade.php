                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/Role of ubuntu.png"
                                            class="img-fluid" alt="">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4>Author: Mr Martin Juuko Kirume</h4>
                                        <a href="assets/files/pdfpublications/TheRoleofUbuntu.pdf">click
                                            here to read/download</a>
                                    </div>
                                </div>
                            </div>
                            
                             <div class="col-lg-3 col-md-6 d-flex align-items-stretch pt-4">
                                <div class="member">
                                    <div class="member-img">
