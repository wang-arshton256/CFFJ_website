                        ...
                        <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <a
                                            href="assets/files/pdfpublications/Barriers Paper 1.pdf">A Plan to Help Families in
                                        Uganda Support Themselves by Removing
                                        Barriers to Wellbeing</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4><a href="{{ url('trade_africe_economics') }}">Trade,
                                                Africa, Economics</a></h4>
                            ...
                            <div class=" col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4><a href="{{ url('family_contraception_law') }}">Family,
                                                Contraception, Law</a></h4>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/exploring green.png"
                                            class="img-fluid" alt="">

                                    </div>
                                    <div class="member-info text-center pt-3">

                                        <h4><a href="{{ url('climate_environment_economics') }}">Climate,
                                                Environment, Economics</a></h4>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4> <a href="{{ url('business_economics') }}">Business,
                                                Economics</a></h4>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4> <a href="{{ url('hunger_agriculture_economics') }}">Hunger,
                                                Agriculture,
                                                Economics</a></h4>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    ...
                                    <div class="member-info text-center pt-3">
                                        ...
                                        <h4> <a href="{{ url('religion') }}">Religion</a></h4>
                            ...
                            <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                                <div class="member">
                                    <div class="member-img">
                                        <img src="assets/img/publications/stimulating_innovation.png"
                                            class="img-fluid" alt="">

                                    </div>
                                    <div class="member-info text-center pt-3">

                                        <h4><a href="{{ url('innovation') }}">Innovation</a></h4>
